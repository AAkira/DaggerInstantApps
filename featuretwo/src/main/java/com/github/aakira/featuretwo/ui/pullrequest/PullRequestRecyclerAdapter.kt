...
class PullRequestRecyclerAdapter(private val data: List<PullRequest>, val clickListener: (PullRequest) -> Unit) :
        RecyclerView.Adapter<PullRequestRecyclerAdapter.ViewHolder>() {
